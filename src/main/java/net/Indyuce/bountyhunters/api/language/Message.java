...
public enum Message {
    ...
    NEW_BOUNTY_ON_YOU(new SoundReader(Sound.ENTITY_ENDERMAN_HURT, 1, 0), "&6{creator} &ejust set a &6${reward}&e bounty on you!"),
    NEW_BOUNTY_ON_YOU_ILLEGAL(new SoundReader(Sound.ENTITY_ENDERMAN_HURT, 1, 0), "&eYou killed a man illegally! A ${reward} bounty was set on you!"),
    NEW_BOUNTY_ON_YOU_UNDEFINED(new SoundReader(Sound.ENTITY_ENDERMAN_HURT, 1, 0), "&eSomeone just set a ${reward} bounty on you!"),
    ...
    NEW_HUNTER_ALERT(new SoundReader(Sound.ENTITY_ENDERMAN_HURT, 1, 0), "&c{hunter} now targets you."),
    ...
    Message(SoundReader sound, String... message) {
