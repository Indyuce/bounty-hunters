...
public class VersionWrapper_1_11_R1 implements VersionWrapper {
	...
	public NBTItem getNBTItem(org.bukkit.inventory.ItemStack item) {
		return new NBTItem_v1_11_R1(item);
	}

	public class NBTItem_v1_11_R1 extends NBTItem {
		private final net.minecraft.server.v1_11_R1.ItemStack nms;
		private final NBTTagCompound compound;

		public NBTItem_v1_11_R1(org.bukkit.inventory.ItemStack item) {
			super(item);
