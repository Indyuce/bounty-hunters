...
public enum CustomItem {
	...
	GUI_PLAYER_HEAD(VersionMaterial.PLAYER_HEAD.toItem(), "{target}", "", "{noCreator}&cThis player is a thug!", "{isCreator}&7You set this bounty.", "{extraCreator}&7Set by &f{creator}&7.",
			"&7" + AltChar.listDash + " The reward is &f${reward}&7.", "&7" + AltChar.listDash + " There are &f{hunters} &7players tracking him.", "", "{isTarget}&cDon't let them kill you.",
			"{isCreator}&eRight click to remove the bounty.", "{isExtra}&eKill him to claim the bounty!", "{isHunter}&7" + AltChar.listDash + " Click to &euntarget &7him.",
