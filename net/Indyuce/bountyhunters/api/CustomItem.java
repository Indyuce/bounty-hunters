...
public enum CustomItem {
	...
	LB_PLAYER_DATA(new ItemStack(Material.SKULL_ITEM, 1, (short) 3), "[%rank%] %name%", "&8&m-----------------------------", "Claimed Bounties: &f%bounties%", "Head Collection: &f%successful-bounties%", "Current Title: &f%title%", "Level: &f%level%", "&8&m-----------------------------"),
	PROFILE(new ItemStack(Material.SKULL_ITEM, 1, (short) 3), "[%level%] %name%", "&8&m--------------------------------", "Claimed Bounties: &f%claimed-bounties%", "Head Collection: &f%successful-bounties%", "Level: &f%level%", "Level Progress: %lvl-progress%", "", "Current Title: &f%current-title%", "", "Type /bounties titles to manage your title.", "Type /bounties quotes to manage your quote.", "&8&m--------------------------------"),
	...
	public void update(FileConfiguration config) {
		...
		this.lore = config.getStringList(name() + ".lore");
	}
